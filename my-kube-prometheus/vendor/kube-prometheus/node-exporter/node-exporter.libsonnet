  ...
  nodeExporter+:: {
    ...
    daemonset:
      ...
      local nodeExporter =
        ...
        container.mixin.resources.withRequests({ cpu: '150m', memory: '200Mi' }) +
        container.mixin.resources.withLimits({ cpu: '300m', memory: '400Mi' });
      ...
      local proxy =
        ...
        container.mixin.resources.withRequests({ cpu: '100m', memory: '200Mi' }) +
        container.mixin.resources.withLimits({ cpu: '200m', memory: '400Mi' });
